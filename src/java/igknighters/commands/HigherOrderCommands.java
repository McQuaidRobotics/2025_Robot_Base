...
public class HigherOrderCommands {
    ...
    return Commands.race(
        ...
        .andThen(
            new ScheduleCommand(
                ...
                LEDCommands.run(
                    led, new LEDSection(0, 0, LedUtil.makeFlash(Color.kGreen, 0.2), 40, "INTAKE"))))
        .withName("Intake");
  }
  ...
  public static Command aim(
    ...
    return Commands.parallel(
            ...
            StemCommands.aimAtSpeaker(
                stem, false, () -> swerve.getState().Pose, () -> swerve.getState().Speeds))
        .withName("Aim");
  }
  ...
  public static class ShootSequences {
    ...
    public static Command autoAimShoot(
        CommandSwerveDrivetrain swerve, Stem stem, Umbrella umbrella, DriverController controller) {
      return Commands.parallel(
