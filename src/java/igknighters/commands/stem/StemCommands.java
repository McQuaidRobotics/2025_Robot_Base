...
public class StemCommands {
                    ...
                    new Translation2d(
                            targetTranslation.getX()
                                    - (currentChassisSpeed.vxMetersPerSecond
                                            * (targetDistance / kUmbrella.NOTE_VELO)),
        ...
        public void execute() {
            ...
            double wristRads =
                    StemSolvers.gravitySolveWristTheta2(
                            ...
                            new Translation3d(
                                    targetTranslation.getX(), targetTranslation.getY(), 0.0),
                            noteMps.value(),
                            false,
                            true);
    ...
    public static Command aimAtSpeaker(
            ...
            boolean canFinish,
            Supplier<Pose2d> poseSupplier,
            Supplier<ChassisSpeeds> veloSupplier) {
        return aimAtSpeaker(
    ...
    public static Command aimAtPassPoint(
        ...
        return new AimAtPassPointCommand(stem, passPoint, canFinish, poseSupplier)
                .withName(
                        String.format(
                                "AimAtPassPoint(x: %.2f, y: %.2f)",
                                passPoint.getX(), passPoint.getY()));
    }
