...
import igknighters.subsystems.swerve.generated.DrivingController;
...
public class TeleopSwerveBaseCmd extends Command {
  ...
  protected Translation2d translationStick() {
    ...
    double magnitude = DrivingController.TELEOP_TRANSLATION_AXIS_CURVE.lerpKeepSign(rawMagnitude);
  ...
  protected Translation2d rotationStick() {
    ...
    rawMagnitude = MathUtil.clamp(rawMagnitude, -1, 1);
    double magnitude = DrivingController.TELEOP_ROTATION_AXIS_CURVE.lerpKeepSign(rawMagnitude);
