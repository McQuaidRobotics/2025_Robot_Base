...
public class ConstantHelper {
  ...
  public static void handleConstField(Field field, Class<?> obj) {
    ...
    RobotConstID constID = RobotConstID.CRASH;
  ...
  //             DriverStation.reportError("Non-static field " + cls.getSimpleName() + "." +
  // field.getName()
  //                     + " in constants", false);
  //             continue;
  //         }
  ...
  // public static void applyRoboConst(Class<igknighters.constants.ConstValues> consts, RobotID id)
  // {
