...
public class StemSolvers {
    ...
    public static double passWristSolveTheta(
        ...
        if (DEBUG_SOLVERS.value()) {
            ...
            DogLog.log(
                    "Subsystems/Stem/StemSolvers" + out + "/ret",
                    offsetPivot ? atan + pivotRads : atan);
        }
     ...
     *
     * @apiNote This can be thought of side view of the robot in cartesian space with the front of
     *     the robot being +X.
    ...
    public static Translation2d solveWristLocationSimple2d(double stemLength, double pivotRads) {
        Translation2d wristLocationVector =
                new Translation2d(
                        stemLength * Math.cos(pivotRads), stemLength * Math.sin(pivotRads));
    ...
    /**
     * Returns the theta of the wrist with gravity compensation given the input parameters in
     * radians.
     *
    ...
    public static double gravitySolveWristTheta(
        ...
        double grav =
                linearSolveWristTheta(stemLength, pivotRads, horizDist, newVerticalDist, true);
        ...
        if (DEBUG_SOLVERS.value()) {
            ...
            DogLog.log(
                    "Subsystems/Stem/StemSolvers" + out + "/vertcialDistanceError",
                    vertcialDistanceError);
            DogLog.log("Subsystems/Stem/StemSolvers" + out + "/newVerticalDist", newVerticalDist);
    ...
    public static record StemSolveInput(
            /**
             * This will define the current position of the stem to be used in more optimized solves
             * that desire as little movement as possible.
             */
            StemPosition currentStemPosition,
            /**
             * This will define any static components of a solve like pivot rads for a stationary
             * pivot solve.
             */
