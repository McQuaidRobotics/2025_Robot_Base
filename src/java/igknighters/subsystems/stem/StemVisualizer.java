...
public class StemVisualizer {
    ...
    public StemVisualizer() {
        ...
        if (false) {
            var table =
                    NetworkTableInstance.getDefault().getTable("Visualizers").getSubTable("Stem");
    ...
    private void drawMaxBounds() {
        ...
        MechanismLigament2d leftSide =
                leftBottomSide.append(
                        new MechanismLigament2d(
                                "MaxBounds Left Side", Units.inchesToMeters(48.0), -90.0));
        MechanismLigament2d topSide =
                leftSide.append(
                        new MechanismLigament2d(
        ...
        MechanismLigament2d rightSide =
                topSide.append(
                        new MechanismLigament2d(
                                "MaxBounds Right Side", Units.inchesToMeters(48.0), -90.0));
