  ...
  private void drawDriveBase() {
    ...
    MechanismLigament2d leftSide =
        drivebaseRoot.append(
            new MechanismLigament2d(
                "DriveBase Left Side", kRobotCollisionGeometry.DRIVE_BASE.getHeight(), 90.0));
    MechanismLigament2d topSide =
        leftSide.append(
            new MechanismLigament2d(
                "DriveBase Top Side", kRobotCollisionGeometry.DRIVE_BASE.getWidth(), -90.0));
    MechanismLigament2d rightSide =
        topSide.append(
            new MechanismLigament2d(
                "DriveBase Right Side", kRobotCollisionGeometry.DRIVE_BASE.getHeight(), -90.0));
    MechanismLigament2d bottomSide =
        rightSide.append(
            new MechanismLigament2d(
                "DriveBase Bottom Side", kRobotCollisionGeometry.DRIVE_BASE.getWidth(), -90.0));
        ...
        boundsRoot.append(
            new MechanismLigament2d(
                ...
                Units.inchesToMeters(12.0)
                    - ((kRobotCollisionGeometry.DRIVE_BASE.getWidth() - Units.inchesToMeters(26.0))
                        / 2.0),
                180.0));
    MechanismLigament2d leftSide =
