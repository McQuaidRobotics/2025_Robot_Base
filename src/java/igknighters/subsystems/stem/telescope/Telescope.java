...
public abstract class Telescope extends Component {
    ...
    /**
     * Move the telescope to the target and returns if it has reached the target. Meant to be used
     * in a kind of polling loop to wait the mechanism to reach the target.
     *
     * @param meters The target distance to move to
