...
public class ShooterReal extends Shooter {
    ...
    private final StatusSignal<AngularVelocity> veloSignalRight, veloSignalLeft;
    private final StatusSignal<Voltage> voltSignalRight, voltSignalLeft;
    private final StatusSignal<Current> currentSignalLeft, currentSignalRight;
    ...
    public double getSpeed() {
        return (super.radiansPerSecondRight
                        + (super.radiansPerSecondLeft / kShooter.LEFT_MOTOR_DIFF))
                / 2.0;
    }
    ...
    public void setSpeed(double speedRadPerSec) {
        ...
        double targetRotsRight =
                Units.radiansToRotations(super.targetRadiansPerSecondRight)
                        / kShooter.MECHANISM_RATIO;
        double targetRotsLeft =
                Units.radiansToRotations(super.targetRadiansPerSecondLeft)
                        / kShooter.MECHANISM_RATIO;
    ...
    public void periodic() {
        ...
        super.radiansPerSecondRight =
                Units.rotationsToRadians(
                        veloSignalRight.getValueAsDouble() * kShooter.MECHANISM_RATIO);
        DogLog.log(
                "Subsystems/Umbrella/Shooter/currentRotsRight", veloSignalRight.getValueAsDouble());
        ...
        super.radiansPerSecondLeft =
                Units.rotationsToRadians(
                        veloSignalLeft.getValueAsDouble() * kShooter.MECHANISM_RATIO);
